...
# Remove default opencv from system and install opencv3.3.0 - >> Visteon Runtime Build Dep
...
# Install protobuf 3.4.0 -- >> Visteon Runtime Build Dep
...
# Install orocos_kinematics -- >> Visteon Runtime Build Dep
...
# Install pcl, gsl, glog, LevelDB, libusb header and urdfdom -- >> Visteon Runtime Build Dep
...
# Install Libusb header and update database -- >> Visteon Runtime Build Dep
...
# Weird OpenCV softlink errors during ament build -- >> Visteon Runtime Build Dep
